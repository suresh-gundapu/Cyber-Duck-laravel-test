        ...
        <div class="row justify-content-center my-4 p-3 mb-5">
            <div class="col-md-8">
                <div class="card shadow  bg-body rounded">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/shipping-cost-addAction') }}" id="form-login">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="shipment" type="text" class="form-control" name="shipment_cost" value="{{ old('shipment_cost') }}" autocomplete="shipment_cost" autofocus>
